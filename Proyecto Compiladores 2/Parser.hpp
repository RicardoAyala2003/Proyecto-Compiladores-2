...
/**
 ** \file Parser.hpp
 ** Define the proyecto::parser class.
 */
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    OP_BRACE = 271,                // OP_BRACE
    CLOSE_BRACE = 272,             // CLOSE_BRACE
    PLUS = 273,                    // PLUS
    MINUS = 274,                   // MINUS
    MULT = 275,                    // MULT
    DIV = 276,                     // DIV
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_KW_IF = 4,                             // KW_IF
        S_KW_ELSE = 5,                           // KW_ELSE
        S_KW_WHILE = 6,                          // KW_WHILE
        S_KW_PRINT = 7,                          // KW_PRINT
        S_KW_INPUT = 8,                          // KW_INPUT
        ...
        S_COMMA = 13,                            // COMMA
        S_OP_PAR = 14,                           // OP_PAR
        S_CLOSE_PAR = 15,                        // CLOSE_PAR
        S_OP_BRACE = 16,                         // OP_BRACE
        S_CLOSE_BRACE = 17,                      // CLOSE_BRACE
        S_PLUS = 18,                             // PLUS
        S_MINUS = 19,                            // MINUS
        S_MULT = 20,                             // MULT
        S_DIV = 21,                              // DIV
        S_MOD = 22,                              // MOD
        S_LESS_THAN = 23,                        // LESS_THAN
        S_GREATER_THAN = 24,                     // GREATER_THAN
        S_LESS_EQUAL = 25,                       // LESS_EQUAL
        S_GREATER_EQUAL = 26,                    // GREATER_EQUAL
        S_EQUAL = 27,                            // EQUAL
        S_DISTINCT = 28,                         // DISTINCT
        S_AND = 29,                              // AND
        S_OR = 30,                               // OR
        S_NOT = 31,                              // NOT
        S_THEN = 32,                             // THEN
        ...
        S_opt_statement_list = 35,               // opt_statement_list
        S_statement_list = 36,                   // statement_list
        S_statement = 37,                        // statement
        S_var_decl = 38,                         // var_decl
        S_assignment = 39,                       // assignment
        S_opt_ident_list = 40,                   // opt_ident_list
        S_ident_decl = 41,                       // ident_decl
        S_opt_assign_expr = 42,                  // opt_assign_expr
        S_if_stmt = 43,                          // if_stmt
        S_while_stmt = 44,                       // while_stmt
        S_print_stmt = 45,                       // print_stmt
        S_input_stmt = 46,                       // input_stmt
        S_block = 47,                            // block
        S_expression = 48,                       // expression
        S_logical_or = 49,                       // logical_or
        S_logical_and = 50,                      // logical_and
        S_equality = 51,                         // equality
        S_comparison = 52,                       // comparison
        S_term = 53,                             // term
        S_factor = 54,                           // factor
        S_unary = 55,                            // unary
        S_primary = 56                           // primary
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_OP_PAR ()
      {
        return symbol_type (token::OP_PAR);
      }
#else
      static
      symbol_type
      ...
      make_OP_BRACE ()
      {
        return symbol_type (token::OP_BRACE);
      }
#else
      static
      symbol_type
      ...
      make_DISTINCT ()
      {
        return symbol_type (token::DISTINCT);
      }
#else
      static
      symbol_type
