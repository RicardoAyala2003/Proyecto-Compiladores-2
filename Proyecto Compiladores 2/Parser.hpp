...
# endif
    ...
    COMMA = 269,                   // COMMA
    OP_PAR = 270,                  // OP_PAR
    CLOSE_PAR = 271,               // CLOSE_PAR
    OP_BRACE = 272,                // OP_BRACE
    CLOSE_BRACE = 273,             // CLOSE_BRACE
    OP_BRACKET = 274,              // OP_BRACKET
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_KW_IF = 7,                             // KW_IF
        S_KW_ELSE = 8,                           // KW_ELSE
        S_KW_WHILE = 9,                          // KW_WHILE
        S_KW_PRINT = 10,                         // KW_PRINT
        S_KW_INPUT = 11,                         // KW_INPUT
        S_ASSIGN = 12,                           // ASSIGN
        S_SEMICOLON = 13,                        // SEMICOLON
        S_COMMA = 14,                            // COMMA
        S_OP_PAR = 15,                           // OP_PAR
        S_CLOSE_PAR = 16,                        // CLOSE_PAR
        S_OP_BRACE = 17,                         // OP_BRACE
        S_CLOSE_BRACE = 18,                      // CLOSE_BRACE
        S_OP_BRACKET = 19,                       // OP_BRACKET
        S_CLOSE_BRACKET = 20,                    // CLOSE_BRACKET
        S_PLUS = 21,                             // PLUS
        S_MINUS = 22,                            // MINUS
        S_MULT = 23,                             // MULT
        S_DIV = 24,                              // DIV
        ...
        S_LESS_EQUAL = 28,                       // LESS_EQUAL
        S_GREATER_EQUAL = 29,                    // GREATER_EQUAL
        S_EQUAL = 30,                            // EQUAL
        S_DISTINCT = 31,                         // DISTINCT
        S_AND = 32,                              // AND
        S_OR = 33,                               // OR
        S_NOT = 34,                              // NOT
        S_DOT = 35,                              // DOT
